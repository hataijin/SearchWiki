...
public class HttpUnitTest {
    ...
    public void get() throws Exception {
        ...
        String result = testHttpConnection.get("http://httpbin.org");
    ...
    public void post() throws Exception {
        TestHttpConnection testHttpConnection = new TestHttpConnection();
        String result = testHttpConnection.post("http://httpbin.org/post", "");
        int response = testHttpConnection.getReponseCode();
    ...
    public void delete() throws Exception {
        TestHttpConnection testHttpConnection = new TestHttpConnection();
        String result = testHttpConnection.delete("http://httpbin.org/delete");
        int response = testHttpConnection.getReponseCode();
    ...
    public void put() throws Exception {
        TestHttpConnection testHttpConnection = new TestHttpConnection();
        String result = testHttpConnection.put("http://httpbin.org/put", "");
        int response = testHttpConnection.getReponseCode();
    ...
    public void putVariable() throws Exception {
        ...
        String result = testHttpConnection.put("http://httpbin.org/put", stringBuilder);
        int response = testHttpConnection.getReponseCode();
